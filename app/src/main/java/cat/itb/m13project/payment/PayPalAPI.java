 ...
 */
public class PayPalAPI extends Activity {
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(PayPalAPI.this, PaymentActivity.class);
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(PayPalAPI.this, PayPalFuturePaymentActivity.class);
    ...
    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(PayPalAPI.this, PayPalProfileSharingActivity.class);
